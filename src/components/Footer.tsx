...
import { Network, Phone, Mail, MapPin, Clock, ArrowRight, Facebook, Linkedin, Instagram } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-3xl font-bold">SHI</span>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                ...
                <div className="flex space-x-2">
                  ...
                  />
                  <button className="bg-gradient-to-r from-primary-600 to-primary-700 px-4 py-2 rounded-lg hover:from-primary-700 hover:to-primary-800 transition-all">
